...
/* --------- INITIALIZATION --------- */
const restockOrderController    = new RestockOrderController(roDAO, testResultDAO);
 ...
 */
 describe('INTEGRATION TEST: RestockOrderController.getReturnItems', () => {
    ...
    beforeAll(() => {
        ...
        /* mock implementation of roDAO.getSkuItemsOfRestockOrder */
        roDAO.getSkuItemsOfRestockOrder.mockImplementation(() => {
            return restockOrdersResult[1].skuItems;
        });

        testResultDAO.getTestResults.mockImplementationOnce(() => {
            return undefined;
        }).mockImplementationOnce(() => {
            return undefined;
        }).mockImplementation(() => {
     ...
     */
     testGetReturnItemsRestockOrder_MOCK(
        'SUCCESS: ',
        2,
        {code: 200, message: restockOrdersResult[1].skuItems}
    );
 ...
 */
 function testGetReturnItemsRestockOrder_MOCK(testName,  ID, expectedResult) {
    test(testName, async () => {
        try {
 ...
 describe('INTEGRATION TEST: RestockOrderController.setSkuItems', () => {
    ...
    beforeAll(() => {
        ...
        roDAO.getRestockOrderById.mockImplementationOnce(() => {
            ...
            return new Array(restockOrderDelivered);
        })
 ...
 describe('INTEGRATION TEST: RestockOrderController.addTransportNote', () => {
    ...
    beforeAll(() => {
        ...
        roDAO.getRestockOrderById.mockImplementationOnce(() => {
            ...
            return new Array(restockOrderDelivery)
        }).mockImplementationOnce(() => {
            return new Array(restockOrderDelivery);
        })
